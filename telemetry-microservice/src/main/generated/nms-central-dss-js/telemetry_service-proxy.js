...
/// <reference path="./telemetry_service-proxy.d.ts" />
...
!function (factory) {
  if (typeof require === 'function' && typeof module !== 'undefined') {
    ...
    // AMD loader
    define('nms-central-dss-js/telemetry_service-proxy', [], factory);
  } else {
    // plain old include
    TelemetryService = factory();
  }
}(function () {
  ...
  /**
   ...
   @class
  */
  var TelemetryService = function(eb, address) {
    var j_eb = eb;
  ...
  if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports) {
      exports = module.exports = TelemetryService;
    } else {
