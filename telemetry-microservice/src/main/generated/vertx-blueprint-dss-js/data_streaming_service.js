...
/** @module vertx-blueprint-dss-js/data_streaming_service */
...
var DataStreamingService = function(j_val) {
  ...
  /**
   ...
   @return {DataStreamingService}
   */
  this.test =  function(ping, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_dataStreamingService["test(java.lang.String,io.vertx.core.Handler)"](__args[0], function(ar) {
        if (ar.succeeded()) {
      ...
      return that;
    } else if (typeof __super_test != 'undefined') {
      return __super_test.apply(this, __args);
    }
    else throw new TypeError('function invoked with invalid arguments');
  };
