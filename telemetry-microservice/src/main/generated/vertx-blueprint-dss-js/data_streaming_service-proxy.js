...
!function (factory) {
  if (typeof require === 'function' && typeof module !== 'undefined') {
    ...
    // AMD loader
    define('vertx-blueprint-dss-js/data_streaming_service-proxy', [], factory);
  } else {
    // plain old include
  ...
  var DataStreamingService = function(eb, address) {
    ...
    this.test =  function(ping, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"ping":__args[0]}, {"action":"test"}, function(err, result) { __args[1](err, result && result.body); });
        return that;
      } else throw new TypeError('function invoked with invalid arguments');
    };
