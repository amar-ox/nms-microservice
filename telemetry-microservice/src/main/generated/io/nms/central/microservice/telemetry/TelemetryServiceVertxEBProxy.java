...
public class TelemetryServiceVertxEBProxy implements TelemetryService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public TelemetryServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public TelemetryServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
