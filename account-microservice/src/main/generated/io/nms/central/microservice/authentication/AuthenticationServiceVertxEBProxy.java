...
public class AuthenticationServiceVertxEBProxy implements AuthenticationService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public AuthenticationServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public AuthenticationServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
