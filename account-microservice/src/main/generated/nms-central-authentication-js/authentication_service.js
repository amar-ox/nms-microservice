...
var JAuthenticationService = Java.type('io.nms.central.microservice.authentication.AuthenticationService');
var Account = Java.type('io.nms.central.microservice.authentication.model.Account');
var Agent = Java.type('io.nms.central.microservice.authentication.model.Agent');
var User = Java.type('io.nms.central.microservice.authentication.model.User');
...
/**
 ...
 @class
*/
var AuthenticationService = function(j_val) {

  var j_authenticationService = j_val;
  var that = this;
  ...
  this.initializePersistence =  function(resultHandler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_authenticationService["initializePersistence(io.vertx.core.Handler)"](function(ar) {
        if (ar.succeeded()) {
          __args[0](null, null);
        } else {
  ...
  this.saveUser =  function(user, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_authenticationService["saveUser(io.nms.central.microservice.authentication.model.User,io.vertx.core.Handler)"](__args[0]  != null ? new User(new JsonObject(Java.asJSONCompatible(__args[0]))) : null, function(ar) {
        if (ar.succeeded()) {
          __args[1](null, null);
        } else {
  ...
  this.retrieveUser =  function(username, resultHandler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_authenticationService["retrieveUser(java.lang.String,io.vertx.core.Handler)"](__args[0], function(ar) {
        if (ar.succeeded()) {
  ...
  this.retrieveAllUsers =  function(resultHandler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_authenticationService["retrieveAllUsers(io.vertx.core.Handler)"](function(ar) {
        if (ar.succeeded()) {
  ...
  this.retrieveUsersByRole =  function(role, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_authenticationService["retrieveUsersByRole(java.lang.String,io.vertx.core.Handler)"](__args[0], function(ar) {
        if (ar.succeeded()) {
  ...
  this.removeUser =  function(username, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_authenticationService["removeUser(java.lang.String,io.vertx.core.Handler)"](__args[0], function(ar) {
        if (ar.succeeded()) {
          __args[1](null, null);
        } else {
          __args[1](null, ar.cause());
  ...
  this.authenticateUser =  function(username, password, resultHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_authenticationService["authenticateUser(java.lang.String,java.lang.String,io.vertx.core.Handler)"](__args[0], __args[1], function(ar) {
        if (ar.succeeded()) {
  ...
  this.saveAgent =  function(agent, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_authenticationService["saveAgent(io.nms.central.microservice.authentication.model.Agent,io.vertx.core.Handler)"](__args[0]  != null ? new Agent(new JsonObject(Java.asJSONCompatible(__args[0]))) : null, function(ar) {
        if (ar.succeeded()) {
          __args[1](null, null);
        } else {
          __args[1](null, ar.cause());
  ...
  this.retrieveAgent =  function(username, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_authenticationService["retrieveAgent(java.lang.String,io.vertx.core.Handler)"](__args[0], function(ar) {
        if (ar.succeeded()) {
          __args[1](utils.convReturnDataObject(ar.result()), null);
        } else {
          __args[1](null, ar.cause());
  ...
  this.retrieveAllAgents =  function(resultHandler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_authenticationService["retrieveAllAgents(io.vertx.core.Handler)"](function(ar) {
        if (ar.succeeded()) {
          __args[0](utils.convReturnListSetDataObject(ar.result()), null);
        } else {
          __args[0](null, ar.cause());
  ...
  this.removeAgent =  function(username, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_authenticationService["removeAgent(java.lang.String,io.vertx.core.Handler)"](__args[0], function(ar) {
        if (ar.succeeded()) {
          __args[1](null, null);
        } else {
          __args[1](null, ar.cause());
  ...
  this.authenticateAgent =  function(username, password, resultHandler) {
    var __args = arguments;
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_authenticationService["authenticateAgent(java.lang.String,java.lang.String,io.vertx.core.Handler)"](__args[0], __args[1], function(ar) {
        if (ar.succeeded()) {
          __args[2](utils.convReturnDataObject(ar.result()), null);
        } else {
          __args[2](null, ar.cause());
  ...
  this._jdel = j_authenticationService;
};

AuthenticationService._jclass = utils.getJavaClass("io.nms.central.microservice.authentication.AuthenticationService");
AuthenticationService._jtype = {accept: function(obj) {
    return AuthenticationService._jclass.isInstance(obj._jdel);
  },wrap: function(jdel) {
    var obj = Object.create(AuthenticationService.prototype, {});
    AuthenticationService.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
AuthenticationService._create = function(jdel) {var obj = Object.create(AuthenticationService.prototype, {});
  AuthenticationService.apply(obj, arguments);
  return obj;
}
AuthenticationService.SERVICE_NAME = JAuthenticationService.SERVICE_NAME;
AuthenticationService.SERVICE_ADDRESS = JAuthenticationService.SERVICE_ADDRESS;
AuthenticationService.UI_ADDRESS = JAuthenticationService.UI_ADDRESS;
