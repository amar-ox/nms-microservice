...
public class FaultServiceVertxEBProxy implements FaultService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public FaultServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FaultServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
