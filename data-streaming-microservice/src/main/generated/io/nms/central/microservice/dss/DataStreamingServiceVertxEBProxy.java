...
public class DataStreamingServiceVertxEBProxy implements DataStreamingService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public DataStreamingServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public DataStreamingServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
