...
CONTROLLER_DIR=$MV_DIR/multiverse-controller
CONSOLE_DIR=$MV_DIR/multiverse-console

ROOT_CA=$MV_DIR/certs/MultiverseRootCA.crt.pem
CONTROLLER_CERT=$MV_DIR/certs/controller
CONSOLE_CERT=$MV_DIR/certs/console

mkdir certs ; cd certs ; mkdir controller ; mkdir console
...
openssl x509 -req -days 365 -sha256 -extfile req.ext -in multiverse.controller.csr -CA ../MultiverseRootCA.crt.pem -CAkey ../MultiverseRootCA.key.pem -CAcreateserial -out multiverse.controller.crt.pem
...
openssl x509 -req -days 365 -sha256 -extfile req.ext -in multiverse.console.csr -CA ../MultiverseRootCA.crt.pem -CAkey ../MultiverseRootCA.key.pem -CAcreateserial -out multiverse.console.crt.pem
